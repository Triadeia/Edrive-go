...
const rituals = [
  ...
  ["Indicacao", "Transformar quem voce conhece da Maldicao da Gasolina."],
  ...
  return (
    <article className="space-y-6">
      ...
      <section className="panel bg-[var(--sidebar)] p-8 text-white">
        ...
        <p className="mt-6 max-w-3xl leading-7 text-white/66">Nao somos apenas um aplicativo. Somos infraestrutura. O motorista entra pela eDrive Go; a fidelizacao acontece pela eDrive Go Energy.</p>
