  ...
  return (
    <article className="space-y-6">
      <section className="panel p-6 sm:p-8">
        ...
        <p className="muted mt-5 max-w-3xl text-lg leading-8">A Libert Drive precisa virar pertencimento. Estes elementos transformam oferta em cultura e cultura em retencao.</p>
