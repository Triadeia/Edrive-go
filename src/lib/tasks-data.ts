...
export const seedTasks: EdriveTask[] = [
  ...
  ["task-energy", "Explicar relacao eDrive Go + eDrive Go Energy", "Criar bloco visual mostrando entrada pela eDrive Go e fidelizacao pela eDrive Go Energy.", "Em revisao", "Alta", "Estrategia", "Ecossistema", "eDrive Go Energy", "2026-06-28", 82],
...
export function normalizeTask(input: Partial<EdriveTask> & { title?: string }): TaskInput {
  return {
    ...
    owner: String(input.owner || "Equipe eDrive Go").slice(0, 80),
